...
{
    /// <inheritdoc />
    public partial class AddSocialAuthAndVerification : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, true, new List<string> { ".NET", "PostgreSQL", "RabbitMQ" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, false, new List<string> { "React Native", "Next.js", "UX Writing" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, false, new List<string> { "Python", "ML.NET", "Vector Search" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, false, new List<string> { "UX Research", "Prototyping", "Storytelling" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, true, new List<string> { "React", "Next.js", "Design Systems" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, false, new List<string> { "Product Discovery", "TypeScript", "Analytics" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, true, new List<string> { "Docker", "Kubernetes", "Grafana" }, null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "GithubId", "GoogleId", "IsEmailVerified", "Skills", "VerificationToken", "VerificationTokenExpiresAt" },
                values: new object[] { null, null, true, new List<string> { "Python", "ETL", "dbt" }, null, null });
