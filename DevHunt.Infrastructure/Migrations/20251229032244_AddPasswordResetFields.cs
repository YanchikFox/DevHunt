    ...
    public partial class AddPasswordResetFields : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { ".NET", "PostgreSQL", "RabbitMQ" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "React Native", "Next.js", "UX Writing" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "Python", "ML.NET", "Vector Search" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "UX Research", "Prototyping", "Storytelling" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "React", "Next.js", "Design Systems" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "Product Discovery", "TypeScript", "Analytics" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "Docker", "Kubernetes", "Grafana" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "PasswordResetToken", "PasswordResetTokenExpiresAt", "Skills" },
                values: new object[] { null, null, new List<string> { "Python", "ETL", "dbt" } });
        }
